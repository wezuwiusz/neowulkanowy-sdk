...
... and more. Check it out [full public api](https://github.com/wulkanowy/api/blob/0.7.5/src/main/kotlin/io/github/wulkanowy/api/Api.kt).
...
dependencies {
    implementation 'io.github.wulkanowy:api:0.7.5'
}
```
