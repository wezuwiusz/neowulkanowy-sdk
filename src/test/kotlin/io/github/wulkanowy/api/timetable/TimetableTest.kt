...
//            assertEquals("Religia", oldSubject)
//            assertEquals("Polonistka Joanna", oldTeacher)
//            assertEquals("3", oldRoom)
...
//            assertEquals("Religia", oldSubject)
//            assertEquals("Religijny Janusz", oldTeacher)
//            assertEquals("3", oldRoom)
...
//            assertEquals("Naprawa komputera", oldSubject)
//            assertEquals("Naprawowy Andrzej", oldTeacher)
//            assertEquals("32", oldRoom)
...
//            assertEquals("Tworzenie i administrowanie bazami danych [zaw2]", oldSubject)
//            assertEquals("Dębicki Robert", oldTeacher)
//            assertEquals("34", oldRoom)
