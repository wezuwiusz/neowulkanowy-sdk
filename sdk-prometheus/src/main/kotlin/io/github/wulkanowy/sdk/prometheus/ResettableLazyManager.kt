...
internal class ResettableLazy<PROPTYPE>(
    ...
    fun makeInitBlock(): Lazy<PROPTYPE> = lazy {
        manager.register(this)
        init()
    }
}

internal fun <PROPTYPE> resettableLazy(manager: ResettableLazyManager, init: () -> PROPTYPE): ResettableLazy<PROPTYPE> = ResettableLazy(manager, init)
